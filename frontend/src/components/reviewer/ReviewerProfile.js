                        ...
                        <div className="card-body">
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    ...
                                    <div className="h5 mb-0 font-weight-bold text-gray-800 ml-3">$40,000</div>
                                </div>
                            ...
                            <div className="row no-gutters align-items-center">
                                <div className="col">
                                    <div className="text-xs ml-2 font-weight-bold text-success text-uppercase mb-1 ml-3">
                                        Earnings (Annual)</div>
                                    <div className="h5 ml-2 mb-0 font-weight-bold text-gray-800 ml-3">$215,000</div>
                                </div>
                ...
                <div className="col-xl-3 col-md-6 mb-4">
                    <div className="card border-left-info shadow h-100 py-2">
                        <div className="card-body">
                            <div className="row no-gutters align-items-center">
                                <div className="col">
                                    <div className="text-xs font-weight-bold text-info text-uppercase mb-1 ml-2">Tasks
                                    </div>
                                    <div className="row no-gutters align-items-center">
                                        <div className="col-auto">
                                            <div className="h5 mb-0 ml-3 mr-2 font-weight-bold text-gray-800 ml-3">50%</div>
                                        </div>
                                        <div className="col">
                                            <div className="progress progress-sm mr-2" style={{width:'70%'}}>
                        ...
                        <div className="card-body">
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    ...
                                    <div className="h5 mb-0 font-weight-bold text-gray-800 ml-3">18</div>
                                </div>
                                <div className="col-auto">
