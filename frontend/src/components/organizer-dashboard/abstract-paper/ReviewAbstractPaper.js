...
export default function ReviewAbstractPaper() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://127.0.0.1:8000/api/abstractSubmitDataStore', formDataToSend);
            console.log(response.data);
            if (response && response.data && response.data.message) {
                console.log(response.data);
                setSuccessMessage('Abstract submitted successfully!');
                resetPdf()
                console.log('Abstract data submitted successfully!');
                setFormData({
                    name_of_conference: '',
                    proposal_type: '',
                    author_name: '',
                    ...
                    <div className='card'>
                        <div className='card-header py-3' style={{ position: 'sticky', top: 0, zIndex: 1 }}>
                            <div className='row'>
                                <div className='col-md-6'>
                                    <h6 className="m-0 font-weight-bold text-primary"><i className="fa fa-shield mr-3"></i>Review Abstracts</h6>
                                </div>
                        ...
                        <div className='card-body' style={{ overflowY: 'auto' }}>
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                <div className='row'>
                                    <div className="col-md-6">
                                        <label>Abstract Themes</label>
                                        <select name="abstract_theme" id='abstract_theme' value={formData.abstract_theme} onChange={handleChange} className="form-control input-lg mb-3">
                                ...
                                <input type='text' id='paper_title' value={formData.paper_title} onChange={handleChange} className='form-control input-lg mb-3' placeholder='Paper Title' name="paper_title" />
                                <div className='row'>
                                    <div className='col-md-6'>
                                ...
                                <div className="row">
                                    ...
                                    <div className='col-md-6'>
                                        <label>Status</label>
                                        <select name="status" id='status' value={formData.status} onChange={handleChange} className="form-control input-lg mb-3">
                                ...
                                <label>Remarks</label>
                                <textarea type='text' id='remark' value={formData.remark} onChange={handleChange} placeholder='Remarks' className='form-control input-lg mb-3' name="remark" />
