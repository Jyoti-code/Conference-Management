            ...
            <div className='card' style={{ borderColor: '#fff', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', overflowX: 'auto' }}>
                <div className="card-header" style={{ position: 'sticky', top: 0, zIndex: 1 }}>
                    <div className='row'>
                        <div className='col-md-6 d-flex justify-content-start'>
                            <h6 className="m-0 font-weight-bold text-primary mb-2"><i className="fa fa-table mr-3"></i>Conference Details</h6>
                        </div>
                ...
                <div className='card-body'>
                    <form method="post" onSubmit={handleSubmit}>
                        ...
                        <div className="clearfix"></div>                       
                        <input type="checkbox" onChange={handleCheckboxChange} checked={checkboxChecked} required className='form-check-input ml-1 mr-2' />
                         <p className="ml-4">I/We accept<span style={{ color: '#F00' }}>*</span></p>
                        <div className="clearfix"></div>
                        <div className="personal-details" style={{ paddingBottom: '30px' }}>
                            <div className="clearfix"></div>
                            <div className="g-recaptcha" style={{ marginBottom: '20px' }} data-sitekey="6LeLnPcUAAAAAFrgRyfVep2VVDf2OCyoJrtQ7wbL" required></div>
                            <input type="submit" className="btn btn-primary btn-lg" value="Update" disabled={!checkboxChecked} />
                            <div className="clearfix"></div>
                        </div>
                        </div>
                    </form>
