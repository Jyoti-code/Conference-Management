...
export default function SetAccommodationFeeEdit() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/delegateCategoryFeeStore', formData);
                    ...
                    <div className='card' style={{ borderColor: '#fff', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', overflowX: 'auto' }}>
                        <div className='card-header py-3' style={{ position: 'sticky', top: 0, zIndex: 1 }}>
                            <div className='row'>
                                <div className='col-md-6'>
                                    <h6 className="m-0 font-weight-bold text-primary mb-2"><i className="fa fa-shield mr-3"></i>Accommodation Fee</h6>
                                </div>
                        ...
                        <div className='card-body' style={{ overflowY: 'auto' }}>
                            <form onSubmit={handleSubmit}>
                                ...
                                <label>Rate Per Day/ Per Person</label>
